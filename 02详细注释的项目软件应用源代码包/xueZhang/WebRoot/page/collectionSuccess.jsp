	...
	<div class="row-fluid">
		...
		<div class="span7">
			<h1 class="text-success">
				...
				<strong>恭喜您，收藏成功！</strong>
			</h1>
			<h2 class="text-error">
				<strong>现在您可以：</strong>
			</h2>
			<p class="muted lead">
				<strong><em>马上查看您收藏的商品了！</em></strong>
			</p> <button class="btn btn-success" onclick=window.open("page/infomanager.jsp","_self") type="button">查看收藏夹</button>
			<button class="btn btn-danger" onclick=window.open("home/home.jsp","_self") type="button">返回首页</button>
		</div>
	</div>
</div>
		<div class="row-fluid">
