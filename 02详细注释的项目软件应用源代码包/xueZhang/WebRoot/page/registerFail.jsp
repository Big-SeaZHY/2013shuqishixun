  ...
  <body>
	...
	<div class="row-fluid">
		<div class="span5" align="right">
			<img alt="140x140" src="image/09.jpg" />
		</div>
		<div class="span7">
			<h1 class="muted">
				<img src="image/08.ico" />
				<strong>很抱歉，注册失败！</strong>
			</h1>
			<h2 class="text-error">
				<strong>可能的问题：</strong>
			</h2>
			<p class="muted lead">
				<span><em>您填写的信息有错误！</em></span>
			</p> <button class="btn btn-primary btn-large" onclick=window.open("page/register.jsp","_self") type="button">重新注册</button>
		</div>
	</div>
</div>
		<div class="row-fluid">
